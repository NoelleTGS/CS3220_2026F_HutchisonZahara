# Lab1. Part 1: Kings battles visualization in Game of Thrones
...
def buildGraph(battles_df_cleaned):
    ...
    # node's value = N of kings this king has attacked + 1
...
def main():
    ...
    with tab1:
        ...
        # Load HTML in HTML component for display on Streamlit page
